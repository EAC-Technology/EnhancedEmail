...
Function tt(e, mailbox)
    vdomxml = "<CONTAINER name=""container1"" designcolor=""84A2F0"" top=""9"" height=""443"" width=""561"" left=""18"">"&_
     ...
     'letter = Dictionary("content","readStatus")
     letter = Dictionary
     letter("content") = args("message")
     letter("readStatus")=Array
     dbdictionary( myguid ) = tojson(letter)
     logger(dbdictionary( myguid ))
    ...
    e.get_data = "{""plugin_guid"": ""5d525ea5-bb1d-4eab-b5c3-77a30b5ebe67"", ""async"": 0, ""data"": {""dbkey"": """+ myguid +""", ""type"" : ""secured""}, ""name"": ""loaddata""}"          ' data to be sent as pattern for GET request (string)
    ...
    e.post_data = "{""plugin_guid"": ""5d525ea5-bb1d-4eab-b5c3-77a30b5ebe67"", ""async"": 0, ""data"": {""dbkey"": """+ myguid +""", ""type"" : ""secured""}, ""name"": ""loaddata""}"        ' data to be sent as pattern for POST
                                ' request (string)
